...
Ein Selbsttest zu Gewohnheiten: 133 konkrete Verhaltensweisen in 16 Verhaltensdomaenen,
...
und `Habit Score/Prototyp/testset_v11.json` (die Fragen). Der Runner prueft den
...
Fragensatz eingefroren am 10.09.2026 (133 Items). Aenderungen an den Fragen gehen in eine
